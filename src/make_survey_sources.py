...
file_names_websites = {
    ...
    "mastodon": "Mastodon/etc (social media)",
    ...
    "pronouns page": "Pronouns.page (wiki website)",
    ...
    "telegram": "Telegram/WhatsApp/etc (messenger)",
    ...
    "whatsapp": "Telegram/WhatsApp/etc (messenger)",
